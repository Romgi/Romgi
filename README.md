<p align="center">
  <img src="./assets/banner.svg" width="100%" alt="Jonathan Graydon — software, systems, and robotics. Computer Science at McMaster University, Toronto." />
</p>
...
**Web** &nbsp; React · Next.js · Tailwind CSS · Prisma · PostgreSQL<br/>
**Robotics & vision** &nbsp; WPILib · PathPlanner · OpenCV · AprilTag<br/>
...
<a href="https://github.com/Romgi?tab=overview">
  <picture>
    ...
    <img src="./assets/activity.svg" width="100%" alt="GitHub contributions, active days, and longest streak over the past 365 days. The text version of the widget data is linked below." />
  </picture>
</a>

<picture>
  <source media="(max-width: 600px)" srcset="./assets/languages-mobile.svg" />
  <img src="./assets/languages.svg" width="100%" alt="Language distribution by code bytes across my public, original, non-archived repositories. The text version of the widget data is linked below." />
</picture>

<sub>Generated from GitHub data and refreshed daily. Language share reflects repository code, not proficiency.</sub>
